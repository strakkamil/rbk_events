<footer>
  ...
  <a class="" href="mailto:<?= EMAIL ?>"><img src="assets/images/mail.svg" alt="Ikona mail" />
    <?= EMAIL ?></a>
  <a href="tel:<?= PHONE ?>"><img src="assets/images/phone.svg" alt="Ikona mail" /> <?= SHOW_PHONE ?></a>
  <div class="socials">
    <a target="_blank" href="https://www.facebook.com/rbkevents.mrobak/" aria-label="Facebook">
      <img src="assets/images/logo-facebook.svg" alt="logo-facebook" />
    </a>
    ...
    <a target="_blank" href="https://www.youtube.com/michalrobak" aria-label="YouTube">
      <img src="assets/images/logo-youtube.svg" alt="logo-youtube" />
    </a>
  </div>
